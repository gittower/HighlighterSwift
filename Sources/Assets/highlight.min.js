/*!
  Highlight.js v11.9.0 (git: 10f09543c6)
...
Z;G(e,e.begin,{key:"beginScope"}),e.begin=h(e.begin,{joinWith:""})}})(e),(e=>{
if(Array.isArray(e.end)){
if(e.skip||e.excludeEnd||e.returnEnd)throw K("skip, excludeEnd, returnEnd not compatible with endScope: {}"),
Z
;if("object"!=typeof e.endScope||null===e.endScope)throw K("endScope must be object"),
Z;G(e,e.end,{key:"endScope"}),e.end=h(e.end,{joinWith:""})}})(e)}function Q(e){
function n(n,t){
...
}],relevance:0},l={className:"meta",begin:/#\s*[a-z]+\b/,end:/$/,contains:[{
begin:/\\\n/,relevance:0},e.inherit(o,{className:"string"}),{className:"string",
begin:/<.*?>/},t,e.C_BLOCK_COMMENT_MODE]},d={className:"title",
begin:n.optional(i)+e.IDENT_RE,relevance:0
},g=n.optional(i)+e.IDENT_RE+"\\s*\\(",u=["asm","auto","break","case","continue","default","do","else","enum","extern","for","fortran","goto","if","inline","register","restrict","return","sizeof","struct","switch","typedef","union","volatile","while","_Alignas","_Alignof","_Atomic","_Generic","_Noreturn","_Static_assert","_Thread_local","alignas","alignof","noreturn","static_assert","thread_local","_Pragma"],b={
keyword:u,
...
},m={scope:"symbol",begin:"\\b(?!("+u.join("|")+")\\b)[a-zA-Z_][a-zA-Z0-9_]*",
relevance:0},p={scope:"operator",
begin:"(->|!=|!|==|=|\\+\\+|\\+=|\\+|\\-\\-|\\-=|\\-|\\*=|\\*|/=|/|%=|%|\\^=|\\^|\\|\\||\\|=|\\||~|&&|&=|&|\\?|:|\\<\\<=|\\<\\<|\\<|\\>\\>=|\\>\\>|\\>)",
relevance:0},_={scope:"punctuation",begin:"(\\;|\\,|{|}|\\(|\\)|\\[|\\])",
relevance:0},h=[l,s,t,e.C_BLOCK_COMMENT_MODE,c,o,m,p,_],f={variants:[{begin:/=/,
end:/;/},{begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
keywords:b,contains:h.concat([{begin:/\(/,end:/\)/,keywords:b,
contains:h.concat(["self"]),relevance:0}]),relevance:0},E={
begin:"("+r+"[\\*&\\s]+)+"+g,returnBegin:!0,end:/[{;=]/,excludeEnd:!0,
keywords:b,illegal:/[^\w\s\*&:<>.]/,contains:[{begin:a,keywords:b,relevance:0},{
begin:g,returnBegin:!0,contains:[e.inherit(d,{className:"title.function"})],
relevance:0},{relevance:0,match:/,/},{className:"params",begin:/\(/,end:/\)/,
keywords:b,relevance:0,contains:[t,e.C_BLOCK_COMMENT_MODE,o,c,s,m,p,_,{
begin:/\(/,end:/\)/,keywords:b,relevance:0,
contains:["self",t,e.C_BLOCK_COMMENT_MODE,o,c,s,m,p,_]}]
},s,m,p,_,t,e.C_BLOCK_COMMENT_MODE,l]};return{name:"C",aliases:["h"],keywords:b,
disableAutodetect:!0,illegal:"</",contains:[].concat(f,E,h,p,_,[l,{
begin:e.IDENT_RE+"::",keywords:b},{className:"class",
beginKeywords:"enum class struct union",end:/[{;:<>=]/,contains:[{
beginKeywords:"final class struct"},e.TITLE_MODE]}]),exports:{preprocessor:l,
strings:o,keywords:b}}},grmr_cpp:e=>{const n=e.regex,t=e.COMMENT("//","$",{
contains:[{begin:/\\\n/}]
...
3:"delimiter",4:"symbol",5:"delimiter"},relevance:0}]},a={scope:"strong",
contains:[],variants:[{begin:/_{2}(?!\s)/,end:/_{2}/},{begin:/\*{2}(?!\s)/,
end:/\*{2}/}]},i={scope:"emphasis",contains:[],variants:[{begin:/\*(?![*\s])/,
end:/\*/},{begin:/_(?![_\s])/,end:/_/,relevance:0}]},r=e.inherit(a,{contains:[]
}),s=e.inherit(i,{contains:[]});a.contains.push(s),i.contains.push(r)
;let o=[n,t];return[a,i,r,s].forEach((e=>{e.contains=e.contains.concat(o)
})),o=o.concat(a,i),{name:"Markdown",aliases:["md","mkdown","mkd"],contains:[{
scope:"section",variants:[{begin:"^#{1,6}",end:"$",contains:o},{
begin:"(?=^.+?\\n[=-]{2,}$)",contains:[{begin:"^[=-]*$"},{begin:"^",end:"\\n",
contains:o}]}]},n,{scope:"bullet",begin:"^[ \t]*([*+-]|(\\d+\\.))(?=\\s+)",
end:"\\s+",excludeEnd:!0},a,i,{scope:"quote",begin:"^>\\s+",contains:o,end:"$"
},{scope:"code",variants:[{begin:"(`{3,})[^`](.|\\n)*?\\1`*[ ]*"},{
begin:"(~{3,})[^~](.|\\n)*?\\1~*[ ]*"},{begin:"```",end:"```+[ ]*$"},{
begin:"~~~",end:"~~~+[ ]*$"},{begin:"`.+?`"},{begin:"(?=^( {4}|\\t))",
contains:[{begin:"^( {4}|\\t)",end:"(\\n)$"}],relevance:0}]},{
begin:"^[-\\*]{3,}",end:"$"},t,{begin:[/^ {0,3}\[/,/[^\]]+/,/\]:\s+/,/[^\s]+/],
beginScope:{1:"delimiter",2:"symbol",3:"delimiter",4:"link"},relevance:0}]}},
grmr_objectivec:e=>{
const n=/@[a-zA-Z_][a-zA-Z0-9_]*/,t=["while","export","sizeof","typedef","const","struct","for","union","volatile","static","mutable","if","do","return","goto","enum","else","break","extern","asm","case","default","register","explicit","typename","switch","continue","inline","readonly","assign","readwrite","self","@synchronized","id","typeof","nonatomic","IBOutlet","IBAction","strong","weak","copy","in","out","inout","bycopy","byref","oneway","__strong","__weak","__block","__autoreleasing","__bridge","__bridge_transfer","__bridge_retained","__bridge_retain","__covariant","__contravariant","__kindof","_Nonnull","_Nullable","_Null_unspecified","__FUNCTION__","__PRETTY_FUNCTION__","__attribute__","getter","setter","retain","unsafe_unretained","nonnull","nullable","null_unspecified","null_resettable","class","instancetype","NS_DESIGNATED_INITIALIZER","NS_UNAVAILABLE","NS_REQUIRES_SUPER","NS_RETURNS_INNER_POINTER","NS_INLINE","NS_AVAILABLE","NS_DEPRECATED","NS_ENUM","NS_OPTIONS","NS_SWIFT_UNAVAILABLE","NS_ASSUME_NONNULL_BEGIN","NS_ASSUME_NONNULL_END","NS_REFINED_FOR_SWIFT","NS_SWIFT_NAME","NS_SWIFT_NOTHROW","NS_DURING","NS_HANDLER","NS_ENDHANDLER","NS_VALUERETURN","NS_VOIDRETURN"],a={
$pattern:n,keyword:["@interface","@class","@protocol","@implementation"]}
;return{name:"Objective-C",
aliases:["mm","objc","obj-c","obj-c++","objective-c++"],keywords:{
"variable.language":["this","super"],$pattern:/[a-zA-Z_][a-zA-Z0-9_]*/,
keyword:t,literal:["false","true","FALSE","TRUE","nil","YES","NO","NULL"],
...
contains:[e.UNDERSCORE_TITLE_MODE]},{scope:"keyword",$pattern:n,
...
begin:"\\b(?!("+t.concat(a.keyword).join("|")+")\\b)[a-zA-Z@_][a-zA-Z0-9_]*",
...
const n=e.regex,t=/[\p{XID_Start}_]\p{XID_Continue}*/u,a=["and","as","assert","async","await","break","case","class","continue","def","del","elif","else","except","finally","for","from","global","if","import","in","is","lambda","match","nonlocal|10","not","or","pass","raise","return","try","while","with","yield"],i=["__import__","abs","all","any","ascii","bin","bool","breakpoint","bytearray","bytes","callable","chr","classmethod","compile","complex","delattr","dict","dir","divmod","enumerate","eval","exec","filter","float","format","frozenset","getattr","globals","hasattr","hash","help","hex","id","input","int","isinstance","issubclass","iter","len","list","locals","map","max","memoryview","min","next","object","oct","open","ord","pow","print","property","range","repr","reversed","round","set","setattr","slice","sorted","staticmethod","str","sum","super","tuple","type","vars","zip"],r=["__debug__","Ellipsis","False","None","NotImplemented","True"],s=["Any","Callable","Coroutine","Dict","List","Literal","Generic","Optional","Sequence","Set","Tuple","Type","Union"],o={
$pattern:/[A-Za-z]\w+|__\w+__/,keyword:a,built_in:i,literal:r,type:s},c={
scope:"symbol",
begin:"\\b(?!("+a.concat(i).concat(r).concat(s).join("|")+")\\b)[A-Za-z_][A-Za-z0-9_]*",
relevance:0},l={className:"meta",begin:/^(>>>|\.\.\.) /},d={className:"subst",
begin:/\{/,end:/\}/,keywords:o,illegal:/#/},g={begin:/\{\{/,relevance:0},u={
className:"string",contains:[e.BACKSLASH_ESCAPE],variants:[{
begin:/([uU]|[bB]|[rR]|[bB][rR]|[rR][bB])?'''/,end:/'''/,
contains:[e.BACKSLASH_ESCAPE,l],relevance:10},{
begin:/([uU]|[bB]|[rR]|[bB][rR]|[rR][bB])?"""/,end:/"""/,
contains:[e.BACKSLASH_ESCAPE,l],relevance:10},{
begin:/([fF][rR]|[rR][fF]|[fF])'''/,end:/'''/,
contains:[e.BACKSLASH_ESCAPE,l,g,d]},{begin:/([fF][rR]|[rR][fF]|[fF])"""/,
end:/"""/,contains:[e.BACKSLASH_ESCAPE,l,g,d]},{begin:/([uU]|[rR])'/,end:/'/,
relevance:10},{begin:/([uU]|[rR])"/,end:/"/,relevance:10},{
begin:/([bB]|[bB][rR]|[rR][bB])'/,end:/'/},{begin:/([bB]|[bB][rR]|[rR][bB])"/,
end:/"/},{begin:/([fF][rR]|[rR][fF]|[fF])'/,end:/'/,
contains:[e.BACKSLASH_ESCAPE,g,d]},{begin:/([fF][rR]|[rR][fF]|[fF])"/,end:/"/,
contains:[e.BACKSLASH_ESCAPE,g,d]},e.APOS_STRING_MODE,e.QUOTE_STRING_MODE]
},b="[0-9](_?[0-9])*",m=`(\\b(${b}))?\\.(${b})|\\b(${b})\\.`,p="\\b|"+a.join("|"),_={
className:"number",relevance:0,variants:[{
begin:`(\\b(${b})|(${m}))[eE][+-]?(${b})[jJ]?(?=${p})`},{begin:`(${m})[jJ]?`},{
begin:`\\b([1-9](_?[0-9])*|0+(_?0)*)[lLjJ]?(?=${p})`},{
begin:`\\b0[bB](_?[01])+[lL]?(?=${p})`},{begin:`\\b0[oO](_?[0-7])+[lL]?(?=${p})`
},{begin:`\\b0[xX](_?[0-9a-fA-F])+[lL]?(?=${p})`},{begin:`\\b(${b})[jJ](?=${p})`
}]},h={className:"comment",begin:n.lookahead(/# type:/),end:/$/,keywords:o,
...
},{scope:"punctuation",match:/\)/,endsParent:!0},l,_,u,e.HASH_COMMENT_MODE]}]}
;return d.contains=[u,_,l],{name:"Python",aliases:["py","gyp","ipython"],
unicodeRegex:!0,keywords:o,illegal:/(<\/|\?)|=>/,contains:[l,_,{begin:/\bself\b/
},{beginKeywords:"if",relevance:0},u,h,e.HASH_COMMENT_MODE,{
...
contains:[_,f,u]},{scope:"operator",
begin:"(\\+|-|\\*\\*|\\*|//|/|%|@|<<|<=|<|>>|>=|>|&|\\||\\^|~|:=|==|!=)",
relevance:0},{scope:"punctuation",
begin:"(\\(|\\)|\\[|\\]|\\{|\\}|,|:|\\.|;|=|->|\\+=|-=|\\*=|/=|//=|%=|@=|&=|\\|=|\\^=|>>=|<<=|\\*\\*=)",
relevance:0},c]}},grmr_python_repl:e=>({aliases:["pycon"],contains:[{
...
},r=Ae.filter((e=>"string"==typeof e)).concat(["_|0"]),s={variants:[{
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Se).map(ke),...Me)}]},o={
$pattern:m(/\b\w+/,/#\w+/),keyword:r.concat(Re),literal:Ce},c=[i,s],l=[{
match:b(/\./,m(...De)),relevance:0},{className:"built_in",
match:b(/\b/,m(...De),/(?=\()/)}],g=[{className:"operator",relevance:0,
variants:[{match:Be},{match:`\\.(\\.|${Le})+`}]
}],u="([0-9]_*)+",p="([0-9a-fA-F]_*)+",_={className:"number",relevance:0,
variants:[{match:`\\b(${u})(\\.(${u}))?([eE][+-]?(${u}))?\\b`},{
match:`\\b0x(${p})(\\.(${p}))?([pP][+-]?(${u}))?\\b`},{match:/\b0o([0-7]_*)+\b/
},{match:/\b0b([01]_*)+\b/}]},h=(e="")=>({className:"subst",variants:[{
match:b(/\\/,e,/[0\\tnr"']/)},{match:b(/\\/,e,/u\{[0-9a-fA-F]{1,8}\}/)}]
}),f=(e="")=>({className:"subst",match:b(/\\/,e,/[\t ]*(?:[\r\n]|\r\n)/)
}),E=(e="")=>({className:"subst",label:"interpol",begin:b(/\\/,e,/\(/),end:/\)/
}),y=(e="")=>({begin:b(e,/"""/),end:b(/"""/,e),contains:[h(e),f(e),E(e)]
}),N=(e="")=>({begin:b(e,/"/),end:b(/"/,e),contains:[h(e),E(e)]}),w={
className:"string",
variants:[y(),y("#"),y("##"),y("###"),N(),N("#"),N("##"),N("###")]
},v=[e.BACKSLASH_ESCAPE,{begin:/\[/,end:/\]/,relevance:0,
contains:[e.BACKSLASH_ESCAPE]}],O={begin:/\/[^\s](?=[^/\n]*\/)/,end:/\//,
contains:v},k=e=>{const n=b(e,/\//),t=b(/\//,e);return{begin:n,end:t,
contains:[...v,{scope:"comment",begin:`#(?!.*${t})`,end:/$/}]}},x={
scope:"regexp",variants:[k("###"),k("##"),k("#"),O]},M={match:b(/`/,Fe,/`/)},S={
className:"variable",match:`\\$${ze}+`},A={className:"symbol",
match:"\\b(?!"+m(...Ae)+"\\b)"+Fe,relevance:0},C=[M,{className:"variable",
match:/\$\d+/},S],T=[{match:/(@|#(un)?)available/,scope:"keyword",starts:{
contains:[{begin:/\(/,end:/\)/,keywords:Pe,contains:[...g,_,w]}]}},{
...
begin:/</,end:/>/,keywords:o,contains:[...a,...c,...T,{match:/->/,relevance:0
},R]};R.contains.push(D);const I={begin:/\(/,end:/\)/,relevance:0,
contains:["self",{match:[A.match,/\s*:/],className:{1:"title.function",
2:"punctuation"},keywords:"_|0",relevance:0},...a,x,...c,...l,...g,{
className:"punctuation",match:/(\.|,|\:|\?)/,relevance:0},_,w,...C,...T,R,A]
},L={begin:/</,end:/>/,keywords:"repeat each",contains:[...a,R]},B={
begin:m(d(b(Fe,/\s*:/)),d(b(Fe,/\s+/,Fe,/\s*:/))),end:d(/:/),excludeEnd:!0,
relevance:0,contains:[{match:[Fe,/\s+/,Fe],className:{1:"title.function",
3:"params"}},{match:/\b_\b/,className:"keyword"},{match:Fe,
className:"title.function"}]},$={begin:d(/\(/),end:d(/\)/),keywords:o,
contains:[B,...a,...c,...g,{className:"punctuation",
match:/(\.|,|\:|\?|!|\[|\]|\()/,relevance:0},_,w,...T,R,I,A],endsParent:!0,
illegal:/["']/},z={match:[/(func|macro)/,/\s+/,m(M.match,Fe,Be)],className:{
1:"keyword",3:"title.function"},contains:[L,$,n],illegal:[/\[/,/%/]},F={
match:[m(M.match,Fe,Be),/[?]?/,d(/\(/)],className:{1:"title.function",
2:"punctuation"},contains:[L,$,n],illegal:/\[|%/},U={
match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"title.function"
},contains:[L,$,n],illegal:/\[|%/},j={match:[/operator/,/\s+/,Be],className:{
1:"keyword",3:"title"}},P={begin:[/precedencegroup/,/\s+/,Ue],className:{
1:"keyword",3:"title"},contains:[R],keywords:[...Te,...Ce],end:/}/}
;for(const e of w.variants){const n=e.contains.find((e=>"interpol"===e.label))
;n.keywords=o;const t=[...c,...l,...g,_,w,...C];n.contains=[...t,{begin:/\(/,
end:/\)/,contains:["self",...t]}]}return{name:"Swift",keywords:o,
contains:[...a,z,F,U,{
beginKeywords:"struct protocol class extension enum actor",end:d(/(->|\{)/),
excludeEnd:!0,keywords:o,contains:[e.inherit(e.TITLE_MODE,{
className:"title.class",begin:/[A-Za-z$_][\u00C0-\u02B80-9A-Za-z$_]*/}),...c,{
className:"punctuation",match:/(\:|,)/}]},j,P,{className:"meta",
beginKeywords:"import",end:/$/,contains:[...a],relevance:0},x,...c,...l,...g,{
className:"punctuation",match:/(\.|,|\:|\?|\(|\)|\{|\}|\[|\])/,relevance:0
},_,w,...C,...T,R,I,A]}},grmr_typescript:e=>{
...
className:"attrvalue",endsParent:!0,variants:[{begin:/"/,end:/"/,contains:[a]},{
